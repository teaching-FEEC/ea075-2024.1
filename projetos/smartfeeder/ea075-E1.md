...
> O sistema deverá tratar a configuração de horário para acionamento do dispenser. Além da configuração de quantidade da porção. A partir disso irá periodicamente acionar a quantidade  correta de porção liberada para tigela quando houver o acionamento deste dispenser. Deverá também acionar avisos distintos ao usuário quando o reservatório estiver vazio ( e quando a tigela estiver vazia (contabilizando uma refeição do pet).
